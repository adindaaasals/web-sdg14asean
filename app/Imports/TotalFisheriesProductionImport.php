...
class TotalFisheriesProductionImport implements ToModel, WithHeadingRow
{
    /**
    ...
    public function model(array $row)
{
    ...
    TotalFisheriesProduction::updateOrCreate(
        ['country_id' => $country->id], // Kondisi pencarian
        [
            'total_fisheries_production_2020' => $row['2020'] ?? null,
            'total_fisheries_production_2021' => $row['2021'] ?? null,
            'total_fisheries_production_2022' => $row['2022'] ?? null,
        ]
    );
