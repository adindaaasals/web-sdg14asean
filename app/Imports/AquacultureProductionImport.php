...
class AquacultureProductionImport implements ToModel, WithHeadingRow
{
    /**
    ...
    public function model(array $row)
{
    ...
    AquacultureProduction::updateOrCreate(
        ['country_id' => $country->id], // Kondisi pencarian
        [
            'aquaculture_production_2020' => $row['2020'] ?? null,
            'aquaculture_production_2021' => $row['2021'] ?? null,
            'aquaculture_production_2022' => $row['2022'] ?? null,
        ]
    );
