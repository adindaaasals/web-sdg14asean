...
class TotalFisheriesProductionController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = TotalFisheriesProduction::select('country_code', 'country_name', "total_fisheries_production_{$year} as value")->get();
    ...
    {
        $data = TotalFisheriesProduction::find($id);
        if ($data) {
